...
public enum OrderTypeEnum {
	...
	FIRST_ONE_MONTH(1001, 20, 30, "一个月(每月流量:150G)", 10*100),
	FIRST_THREE_MONTH(1003, 20, 90, "三个月(每月流量:150G)", 30*100),
	FIRST_SIX_MONTH(1006, 20, 180, "六个月(每月流量:150G)", 50*100),
	FIRST_12_MONTH(1012, 20, 365, "12个月(每月流量:150G)", 100*100),
