...
Logger.debug = function debugLog(message) {
    this.log(message, Logger.Types.debug);
};

Logger.info = function infoLog(message) {
    this.log(message, Logger.Types.info);
};

Logger.success = function successLog(message){
    this.log(message, Logger.Types.success);
};

Logger.warning = function warningLog(message){
    this.log(message, Logger.Types.warning);
};


Logger.error = function warningLog(message, logStackTrace){
    this.log(message, Logger.Types.warning, logStackTrace);
};
